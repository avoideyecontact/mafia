...
namespace Mafia.Controllers
{
    public class HomeController : Controller
    {
        ...
        */
        ...
        //<Game>
        //Get
        public string SummonFamilyMemberForGame(int id, string Name)
        {
            return JsonSerializer.Serialize(Infrastructure.Methods.GSummonFamilyMemberForGame( id,  Name), options);
        }
